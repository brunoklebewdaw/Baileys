...
export const decompressingIfRequired = (buffer) => __awaiter(void 0, void 0, void 0, function* () {
    if (2 & buffer.readUInt8()) {
        buffer = yield inflatePromise(buffer.slice(1));
    }
    else {
...
export const decodeBinaryNode = (buff) => __awaiter(void 0, void 0, void 0, function* () {
    const decompBuff = yield decompressingIfRequired(buff);
