...
export const makeNewsletterSocket = config => {
	...
	return Object.assign(Object.assign({}, sock), {
		...
		newsletterUpdateName: (jid, name) =>
			__awaiter(void 0, void 0, void 0, function* () {
				return yield newsletterUpdate(jid, { name })
			}),
		newsletterUpdateDescription: (jid, description) =>
			__awaiter(void 0, void 0, void 0, function* () {
		...
		newsletterReactMessage: (jid, serverId, reaction) =>
			__awaiter(void 0, void 0, void 0, function* () {
				yield query({
					tag: 'message',
					attrs: Object.assign(Object.assign({ to: jid }, reaction ? {} : { edit: '7' }), {
						type: 'reaction',
						server_id: serverId,
		...
		subscribeNewsletterUpdates: jid =>
			__awaiter(void 0, void 0, void 0, function* () {
				var _a
				const result = yield query({
					tag: 'iq',
				...
				const duration =
					(_a = liveUpdatesNode === null || liveUpdatesNode === void 0 ? void 0 : liveUpdatesNode.attrs) === null ||
					_a === void 0
						? void 0
						: _a.duration
				return duration ? { duration: duration } : null
			}),
		newsletterAdminCount: jid =>
			__awaiter(void 0, void 0, void 0, function* () {
				const response = yield executeWMexQuery(
					{ newsletter_id: jid },
