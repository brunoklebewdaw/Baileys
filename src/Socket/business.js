...
export const makeBusinessSocket = (config) => {
    ...
    const updateBussinesProfile = (args) => __awaiter(void 0, void 0, void 0, function* () {
        const node = [];
            ...
            node.push({
                ...
                content: args.hours.days.map(dayConfig => {
                    ...
                    if (dayConfig.mode === 'specific_hours') {
                        return Object.assign(Object.assign({}, base), { attrs: Object.assign(Object.assign({}, base.attrs), { open_time: dayConfig.openTimeInMinutes, close_time: dayConfig.closeTimeInMinutes }) });
                    }
                    return base;
                })
            });
    ...
    const updateCoverPhoto = (photo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const removeCoverPhoto = (id) => __awaiter(void 0, void 0, void 0, function* () {
        return yield query({
            tag: 'iq',
            attrs: {
                to: S_WHATSAPP_NET,
