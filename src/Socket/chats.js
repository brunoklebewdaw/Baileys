...
export const makeChatsSocket = config => {
	...
	const getAppStateSyncKey = keyId =>
		__awaiter(void 0, void 0, void 0, function* () {
			const { [keyId]: key } = yield authState.keys.get('app-state-sync-key', [keyId])
			return key
		})
	const fetchPrivacySettings = (...args_1) =>
		__awaiter(void 0, [...args_1], void 0, function* (force = false) {
	...
	const updateMessagesPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('messages', value)
		})
	const updateCallPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('calladd', value)
		})
	const updateLastSeenPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('last', value)
		})
	const updateOnlinePrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('online', value)
		})
	const updateProfilePicturePrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('profile', value)
		})
	const updateStatusPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('status', value)
		})
	const updateReadReceiptsPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('readreceipts', value)
		})
	const updateGroupsAddPrivacy = value =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield privacyQuery('groupadd', value)
		})
	const updateDefaultDisappearingMode = duration =>
		__awaiter(void 0, void 0, void 0, function* () {
			yield query({
				tag: 'iq',
				attrs: {
	...
	const fetchDisappearingDuration = (...jids) =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	const updateProfilePicture = (jid, content, dimensions) =>
		__awaiter(void 0, void 0, void 0, function* () {
			let targetJid
			if (!jid) {
				throw new Boom(
	...
	const removeProfilePicture = jid =>
		__awaiter(void 0, void 0, void 0, function* () {
			let targetJid
			if (!jid) {
				throw new Boom(
	...
	const updateBlockStatus = (jid, action) =>
		__awaiter(void 0, void 0, void 0, function* () {
		...
		__awaiter(void 0, void 0, void 0, function* () {
			...
			if (profiles) {
				...
				const businessHoursConfig = businessHours
					...
					: undefined
				const websiteStr =
					(_a = website === null || website === void 0 ? void 0 : website.content) === null || _a === void 0
						? void 0
						: _a.toString()
				return {
					wid: (_b = profiles.attrs) === null || _b === void 0 ? void 0 : _b.jid,
					address:
						(_c = address === null || address === void 0 ? void 0 : address.content) === null || _c === void 0
							? void 0
							: _c.toString(),
					description:
						((_d = description === null || description === void 0 ? void 0 : description.content) === null ||
						_d === void 0
							? void 0
							: _d.toString()) || '',
					website: websiteStr ? [websiteStr] : [],
					email:
						(_e = email === null || email === void 0 ? void 0 : email.content) === null || _e === void 0
							? void 0
							: _e.toString(),
					category:
						(_f = category === null || category === void 0 ? void 0 : category.content) === null || _f === void 0
							? void 0
							: _f.toString(),
					business_hours: {
						timezone:
							(_g = businessHours === null || businessHours === void 0 ? void 0 : businessHours.attrs) === null ||
							_g === void 0
								? void 0
								: _g.timezone,
						business_config:
	...
	const cleanDirtyBits = (type, fromTimestamp) =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	const resyncAppState = ev.createBufferedFunction((collections, isInitialSync) =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b
			const appStateSyncKeyCache = new Map()
			const getCachedAppStateSyncKey = keyId =>
				__awaiter(void 0, void 0, void 0, function* () {
					var _a
					...
					__awaiter(void 0, void 0, void 0, function* () {
						...
						while (collectionsToHandle.size) {
							...
							for (const name of collectionsToHandle) {
								...
								logger.info(
									`resyncing ${name} from v${state.version}${shouldForceSnapshot ? ' (forcing snapshot)' : ''}`
								)
								nodes.push({
									tag: 'collection',
									attrs: {
							...
							const decoded = yield extractSyncdPatches(
								result,
							...
							for (const key in decoded) {
								...
								try {
									if (snapshot) {
										const { state: newState, mutationMap } = yield decodeSyncdSnapshot(
											name,
											snapshot,
									...
									if (patches.length) {
										const { state: newState, mutationMap } = yield decodePatches(
											name,
											patches,
											states[name],
											getCachedAppStateSyncKey,
	 ...
	 */
	const profilePictureUrl = (jid_1, ...args_1) =>
		__awaiter(void 0, [jid_1, ...args_1], void 0, function* (jid, type = 'preview', timeoutMs) {
			var _a
			...
			return (_a = child === null || child === void 0 ? void 0 : child.attrs) === null || _a === void 0
				? void 0
				: _a.url
		})
	const createCallLink = (type, event, timeoutMs) =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
			const result = yield query(
				{
	...
	const sendPresenceUpdate = (type, toJid) =>
		__awaiter(void 0, void 0, void 0, function* () {
			const me = authState.creds.me
	...
	const appPatch = patchCreate =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			let initial
			let encodeResult
			yield appStatePatchMutex.mutex(() =>
				__awaiter(void 0, void 0, void 0, function* () {
					var _a, _b
					yield authState.keys.transaction(
						() =>
			...
			if (config.emitOwnEvents) {
				...
				const { mutationMap } = yield decodePatches(
					name,
					[Object.assign(Object.assign({}, encodeResult.patch), { version: { version: encodeResult.state.version } })],
					initial,
					getAppStateSyncKey,
					config.options,
					undefined,
	...
	const fetchProps = () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			if (propsNode) {
				if ((_b = propsNode.attrs) === null || _b === void 0 ? void 0 : _b.hash) {
					...
					authState.creds.lastPropHash =
						(_c = propsNode === null || propsNode === void 0 ? void 0 : propsNode.attrs) === null || _c === void 0
							? void 0
							: _c.hash
			...
			const privacyTokenProp =
				(_d = props['10518']) !== null && _d !== void 0 ? _d : props['privacy_token_sending_on_all_1_on_1_messages']
			if (privacyTokenProp !== undefined) {
				serverProps.privacyTokenOn1to1 = privacyTokenProp === 'true' || privacyTokenProp === '1'
			}
			const profilePicProp =
				(_e = props['9666']) !== null && _e !== void 0 ? _e : props['profile_scraping_privacy_token_in_photo_iq']
			if (profilePicProp !== undefined) {
				serverProps.profilePicPrivacyToken = profilePicProp === 'true' || profilePicProp === '1'
			}
			const lidIssueProp =
				(_f = props['14303']) !== null && _f !== void 0 ? _f : props['lid_trusted_token_issue_to_lid']
	...
	const upsertMessage = ev.createBufferedFunction((msg, type) =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			...
			if (
				((_c = (_b = msg.message) === null || _b === void 0 ? void 0 : _b.protocolMessage) === null || _c === void 0
					? void 0
	...
	ev.on('lid-mapping.update', _a =>
		__awaiter(void 0, [_a], void 0, function* ({ lid, pn }) {
			try {
