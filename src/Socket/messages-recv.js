...
export const makeMessagesRecvSocket = config => {
	...
	const fetchMessageHistory = (count, oldestMsgKey, oldestMsgTimestamp) =>
	...
	const requestPlaceholderResend = (messageKey, msgData) =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
			if (!((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.id)) {
				throw new Boom('Not authenticated')
			...
			if (yield placeholderResendCache.get(messageKey === null || messageKey === void 0 ? void 0 : messageKey.id)) {
				...
				yield placeholderResendCache.set(
			...
			setTimeout(
				() =>
					__awaiter(void 0, void 0, void 0, function* () {
						if (
							yield placeholderResendCache.get(messageKey === null || messageKey === void 0 ? void 0 : messageKey.id)
						) {
	...
	const handleMexNewsletterNotification = node =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	const handleNewsletterNotification = node =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
	...
	const sendRetryRequest = (node_1, ...args_1) =>
		__awaiter(void 0, [node_1, ...args_1], void 0, function* (node, forceIncludeKeys = false) {
			var _a, _b
			...
			yield authState.keys.transaction(
				() =>
					__awaiter(void 0, void 0, void 0, function* () {
						const receipt = {
							tag: 'receipt',
				...
				((_b =
					(_a = authState === null || authState === void 0 ? void 0 : authState.creds) === null || _a === void 0
						? void 0
						: _a.me) === null || _b === void 0
					? void 0
					: _b.id) || 'sendRetryRequest'
			)
		})
	/**
	...
	const reissueTcTokenAfterIdentityChange = from => {
		void (() =>
			__awaiter(void 0, void 0, void 0, function* () {
				...
				const senderTs =
					(_a = tcTokenData === null || tcTokenData === void 0 ? void 0 : tcTokenData[tcJid]) === null || _a === void 0
						? void 0
						: _a.senderTimestamp
				...
				const issueJid = yield resolveIssuanceJid(
					normalizedJid,
			...
			logger.debug(
				{ jid: from, err: err === null || err === void 0 ? void 0 : err.message },
				'failed to re-issue tctoken after identity change'
			)
		})
	}
	const handleEncryptNotification = node =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b
			const from = node.attrs.from
	...
	const handleGroupNotification = (fullNode, child, msg) => {
		...
		const affectedParticipantLid =
			((_b = (_a = getBinaryNodeChild(child, 'participant')) === null || _a === void 0 ? void 0 : _a.attrs) === null ||
			_b === void 0
				? void 0
				: _b.jid) || actingParticipantLid
		const affectedParticipantPn =
			((_d = (_c = getBinaryNodeChild(child, 'participant')) === null || _c === void 0 ? void 0 : _c.attrs) === null ||
			_d === void 0
				? void 0
				: _d.phone_number) || actingParticipantPn
		switch (child === null || child === void 0 ? void 0 : child.tag) {
			...
			case 'description':
				const description =
					(_f = (_e = getBinaryNodeChild(child, 'body')) === null || _e === void 0 ? void 0 : _e.content) === null ||
					_f === void 0
						? void 0
						: _f.toString()
			...
			switch (nodeType) {
				...
				case 'picture':
					...
					ev.emit('contacts.update', [
						{
							id:
								...
								((_c = (_b = setPicture || delPicture) === null || _b === void 0 ? void 0 : _b.attrs) === null ||
								_c === void 0
									? void 0
									: _c.hash) ||
								'',
					...
					if (isJidGroup(from)) {
						...
						result.key = Object.assign(Object.assign({}, result.key || {}), {
				...
				case 'account_sync':
					if (child.tag === 'disappearing_mode') {
						...
						ev.emit('creds.update', {
							accountSettings: Object.assign(Object.assign({}, authState.creds.accountSettings), {
				...
				case 'link_code_companion_reg':
					...
					authState.creds.advSecretKey = Buffer.from(hkdf(identityPayload, 32, { info: 'adv_secret' })).toString(
						'base64'
					)
					yield query({
						tag: 'iq',
	...
	const handlePrivacyTokenNotification = node =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			const senderLid =
				node.attrs.sender_lid && isLidUser(jidNormalizedUser(node.attrs.sender_lid))
					...
					: undefined
			const fallbackJid =
				senderLid !== null && senderLid !== void 0 ? senderLid : yield resolveTcTokenJid(from, getLIDForPN)
	...
	const sendMessagesAgain = (key, ids, retryNode) =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
									...
									ev.emit(
										...
										ids.map(id => {
											...
											return {
												...
												update: {
													status,
													messageTimestamp: toNumber(+((_a = attrs.t) !== null && _a !== void 0 ? _a : 0))
												}
											}
										})
									)
	...
	const handleMessage = node =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			try {
				...
				yield messageMutex.mutex(() =>
					__awaiter(void 0, void 0, void 0, function* () {
						var _a, _b, _c, _d, _e, _f
						yield decrypt()
						if (
							((_a = msg.key) === null || _a === void 0 ? void 0 : _a.remoteJid) &&
							((_b = msg.key) === null || _b === void 0 ? void 0 : _b.id) &&
							msg.message &&
							messageRetryManager
						) {
						...
						if (msg.messageStubType === proto.WebMessageInfo.StubType.CIPHERTEXT && msg.category !== 'peer') {
							if (
								((_c = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _c === void 0
									? void 0
									: _c[0]) === MISSING_KEYS_ERROR_TEXT
							) {
								acked = true
								return sendMessageAck(node, NACK_REASONS.ParsingError)
							}
							if (
								((_d = msg.messageStubParameters) === null || _d === void 0 ? void 0 : _d[0]) ===
								NO_MESSAGE_FOUND_ERROR_TEXT
							) {
								...
								const unavailableType =
									(_e = unavailableNode === null || unavailableNode === void 0 ? void 0 : unavailableNode.attrs) ===
										null || _e === void 0
										? void 0
										: _e.type
								if (
								...
								const errorMessage =
									((_f = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _f === void 0
										? void 0
										: _f[0]) || ''
								const isPreKeyError = errorMessage.includes('PreKey')
								logger.debug(`[handleMessage] Attempting retry request for failed decryption`)
								// Handle both pre-key and normal retries in single mutex
								yield retryMutex.mutex(() =>
									__awaiter(void 0, void 0, void 0, function* () {
										try {
											if (!ws.isOpen) {
				...
				if (!acked) {
					yield sendMessageAck(node, NACK_REASONS.UnhandledError).catch(ackErr =>
	...
	const handleBadAck = _a =>
		__awaiter(void 0, [_a], void 0, function* ({ attrs }) {
	...
	const processNodeWithBuffer = (node, identifier, exec) =>
		__awaiter(void 0, void 0, void 0, function* () {
			ev.buffer()
			yield execTask()
			ev.flush()
	...
	ev.on('call', _a =>
		__awaiter(void 0, [_a], void 0, function* ([call]) {
			if (!call) {
				return
			}
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			try {
				...
				yield authState.keys.set({
					tctoken: Object.assign(Object.assign({}, writes), {
						[TC_TOKEN_INDEX_KEY]: {
