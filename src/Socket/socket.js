...
import { DEF_CALLBACK_PREFIX, DEF_TAG_PREFIX, INITIAL_PREKEY_COUNT, MIN_PREKEY_COUNT, MIN_UPLOAD_INTERVAL, NOISE_WA_HEADER, PROCESSABLE_HISTORY_TYPES, TimeMs, UPLOAD_TIMEOUT } from '../Defaults';
import { DisconnectReason } from '../Types';
import { addTransactionCapability, aesEncryptCTR, bindWaitForConnectionUpdate, bytesToCrockford, configureSuccessfulPairing, Curve, derivePairingCodeKey, generateLoginNode, generateMdTagPrefix, generateRegistrationNode, getCodeFromWSError, getErrorCodeFromStreamError, getNextPreKeysNode, makeEventBuffer, makeNoiseHandler, promiseTimeout, signedKeyPair, xmppSignedPreKey } from '../Utils';
import { getPlatformId } from '../Utils/browser-utils';
import { assertNodeErrorFree, binaryNodeToString, encodeBinaryNode, getAllBinaryNodeChildren, getBinaryNodeChild, getBinaryNodeChildren, isLidUser, jidDecode, jidEncode, S_WHATSAPP_NET } from '../WABinary';
...
export const makeSocket = (config) => {
    ...
    const sendRawMessage = (data) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield promiseTimeout(connectTimeoutMs, (resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            try {
    ...
    const waitForMessage = (msgId_1, ...args_1) => __awaiter(void 0, [msgId_1, ...args_1], void 0, function* (msgId, timeoutMs = defaultQueryTimeoutMs) {
        ...
        let onErr;
        try {
            const result = yield promiseTimeout(timeoutMs, (resolve, reject) => {
                onRecv = data => {
                    resolve(data);
                };
                onErr = err => {
            ...
            if (error instanceof Boom && ((_a = error.output) === null || _a === void 0 ? void 0 : _a.statusCode) === DisconnectReason.timedOut) {
    ...
    const query = (node, timeoutMs) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield promiseTimeout(timeoutMs, (resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
            const result = waitForMessage(msgId, timeoutMs).catch(reject);
            sendNode(node)
                .then(() => __awaiter(void 0, void 0, void 0, function* () { return resolve(yield result); }))
                .catch(reject);
        }));
    ...
    const digestKeyBundle = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rotateSignedPreKey = () => __awaiter(void 0, void 0, void 0, function* () {
        const newId = (creds.signedPreKey.keyId || 0) + 1;
        const skey = yield signedKeyPair(creds.signedIdentityKey, newId);
        yield query({
            tag: 'iq',
    ...
    const executeUSyncQuery = (usyncQuery) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const onWhatsApp = (...phoneNumber) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        let usyncQuery = new USyncQuery();
        let contactEnabled = false;
        for (const jid of phoneNumber) {
            if (isLidUser(jid)) {
                logger === null || logger === void 0 ? void 0 : logger.warn('LIDs are not supported with onWhatsApp');
                continue;
            }
            else {
                if (!contactEnabled) {
        ...
        const results = yield executeUSyncQuery(usyncQuery);
        if (results) {
            return results.list.filter(a => !!a.contact).map(({ contact, id }) => ({ jid: id, exists: contact }));
        }
    });
    const pnFromLIDUSync = (jids) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const validateConnection = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield sendRawMessage(proto.HandshakeMessage.encode({
            clientFinish: {
                static: keyEnc,
                payload: payloadEnc
            }
        }).finish());
        yield noise.finishInit();
    ...
    const uploadPreKeys = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (count = MIN_PREKEY_COUNT, retryCount = 0) {
        ...
        if (uploadPreKeysPromise) {
            ...
            yield uploadPreKeysPromise;
        }
        const uploadLogic = () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            logger.info({ count, retryCount }, 'uploading pre-keys');
            // Generate and save pre-keys atomically (prevents ID collisions on retry)
            const node = yield keys.transaction(() => __awaiter(void 0, void 0, void 0, function* () {
                logger.debug({ requestedCount: count }, 'generating pre-keys with requested count');
                const { update, node } = yield getNextPreKeysNode({ creds, keys }, count);
    ...
    const verifyCurrentPreKeyExists = () => __awaiter(void 0, void 0, void 0, function* () {
        const currentPreKeyId = creds.nextPreKeyId - 1;
        if (currentPreKeyId <= 0) {
            return { exists: false, currentPreKeyId: 0 };
        }
        const preKeys = yield keys.get('pre-key', [currentPreKeyId.toString()]);
    ...
    const uploadPreKeysToServerIfRequired = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { exists: currentPreKeyExists, currentPreKeyId } = yield verifyCurrentPreKeyExists();
    ...
    const onMessageReceived = (data) => __awaiter(void 0, void 0, void 0, function* () {
        yield noise.decodeFrame(data, frame => {
            var _a;
            // reset ping timeout
    ...
    const end = (error) => __awaiter(void 0, void 0, void 0, function* () {
        if (closed) {
    ...
    const requestPairingCode = (phoneNumber, customPairingCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function generatePairingKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const key = yield derivePairingCodeKey(authState.creds.pairingCode, salt);
        ...
        if (node.attrs.lid && ((_a = authState.creds.me) === null || _a === void 0 ? void 0 : _a.id)) {
            ...
            process.nextTick(() => __awaiter(void 0, void 0, void 0, function* () {
                try {
                    ...
                    yield signalRepository.lidMapping.storeLIDPNMappings([{ lid: myLID, pn: myPN }]);
                    // Create device list for our own user (needed for bulk migration)
                    const { user, device } = jidDecode(myPN);
                    yield authState.keys.set({
                        'device-list': {
                            [user]: [(device === null || device === void 0 ? void 0 : device.toString()) || '0']
                        }
                    });
                    // migrate our own session
                    yield signalRepository.migrateSession(myPN, myLID);
    ...
    ws.on('CB:ib,,offline_preview', (node) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updateServerTimeOffset = ({ attrs }) => {
        const tValue = attrs === null || attrs === void 0 ? void 0 : attrs.t;
        if (!tValue) {
            return;
        }
    ...
    const sendUnifiedSession = () => __awaiter(void 0, void 0, void 0, function* () {
        if (!ws.isOpen) {
            return;
        }
        const node = {
...
function mapWebSocketError(handler) {
    return (error) => {
        handler(new Boom(`WebSocket Error (${error === null || error === void 0 ? void 0 : error.message})`, { statusCode: getCodeFromWSError(error), data: error }));
    };
}
