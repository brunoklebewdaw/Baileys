...
export const makeSocket = config => {
	...
	const noise = makeNoiseHandler({
		...
		logger,
		routingInfo:
			(_b = authState === null || authState === void 0 ? void 0 : authState.creds) === null || _b === void 0
				? void 0
				: _b.routingInfo
	})
	...
	const sendRawMessage = data =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			yield promiseTimeout(connectTimeoutMs, (resolve, reject) =>
				__awaiter(void 0, void 0, void 0, function* () {
					try {
	 ...
	 */
	const waitForMessage = (msgId_1, ...args_1) =>
		__awaiter(void 0, [msgId_1, ...args_1], void 0, function* (msgId, timeoutMs = defaultQueryTimeoutMs) {
			var _a, _b
			let onRecv
			let onErr
			try {
				...
				if (
					...
					;(_b = logger === null || logger === void 0 ? void 0 : logger.warn) === null || _b === void 0
						? void 0
						: _b.call(logger, { msgId }, 'timed out waiting for message')
					return undefined
				}
				throw error
			} finally {
	...
	const executeUSyncQuery = usyncQuery =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	const uploadPreKeys = (...args_1) =>
		__awaiter(void 0, [...args_1], void 0, function* (count = MIN_PREKEY_COUNT, retryCount = 0) {
			...
			const uploadLogic = () =>
				__awaiter(void 0, void 0, void 0, function* () {
					...
					const node = yield keys.transaction(
						() =>
							__awaiter(void 0, void 0, void 0, function* () {
						...
						((_a = creds === null || creds === void 0 ? void 0 : creds.me) === null || _a === void 0
							? void 0
							: _a.id) || 'upload-pre-keys'
					)
	...
	const verifyCurrentPreKeyExists = () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	const requestPairingCode = (phoneNumber, customPairingCode) =>
		__awaiter(void 0, void 0, void 0, function* () {
			const pairingCode =
				customPairingCode !== null && customPairingCode !== void 0
					? customPairingCode
					: bytesToCrockford(randomBytes(5))
			if (
				customPairingCode &&
				(customPairingCode === null || customPairingCode === void 0 ? void 0 : customPairingCode.length) !== 8
			) {
...
function mapWebSocketError(handler) {
	return error => {
		handler(
			new Boom(`WebSocket Error (${error === null || error === void 0 ? void 0 : error.message})`, {
