...
export const makeCommunitiesSocket = (config) => {
    ...
    const communityQuery = (jid, type, content) => __awaiter(void 0, void 0, void 0, function* () {
        return query({
            tag: 'iq',
            attrs: {
                type,
    ...
    const communityMetadata = (jid) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield communityQuery(jid, 'get', [{ tag: 'query', attrs: { request: 'interactive' } }]);
        return extractCommunityMetadata(result);
    });
    const communityFetchAllParticipating = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return Object.assign(Object.assign({}, sock), { communityMetadata, communityCreate: (subject, body) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityCreateGroup: (subject, participants, parentCommunityJid) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return yield parseGroupResult(result);
        }), communityLeave: (id) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityUpdateSubject: (jid, subject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityLinkGroup: (groupJid, parentCommunityJid) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityUnlinkGroup: (groupJid, parentCommunityJid) => __awaiter(void 0, void 0, void 0, function* () {
            yield communityQuery(parentCommunityJid, 'set', [
                {
                    tag: 'unlink',
        ...
        }), communityFetchLinkedGroups: (jid) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityRequestParticipantsList: (jid) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityRequestParticipantsUpdate: (jid, participants, action) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityParticipantsUpdate: (jid, participants, action) => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield communityQuery(jid, 'set', [
                {
                    tag: action,
        ...
        }), communityUpdateDescription: (jid, description) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            ...
            yield communityQuery(jid, 'set', [
                {
                    tag: 'description',
                    attrs: Object.assign(Object.assign({}, (description ? { id: generateMessageID() } : { delete: 'true' })), (prev ? { prev } : {})),
                    content: description ? [{ tag: 'body', attrs: {}, content: Buffer.from(description, 'utf-8') }] : undefined
                }
            ]);
        }), communityInviteCode: (jid) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        }), communityRevokeInvite: (jid) => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield communityQuery(jid, 'set', [{ tag: 'invite', attrs: {} }]);
            const inviteNode = getBinaryNodeChild(result, 'invite');
            return inviteNode === null || inviteNode === void 0 ? void 0 : inviteNode.attrs.code;
        }), communityAcceptInvite: (code) => __awaiter(void 0, void 0, void 0, function* () {
         ...
         */
        communityRevokeInviteV4: (communityJid, invitedJid) => __awaiter(void 0, void 0, void 0, function* () {
         ...
         */
        communityAcceptInviteV4: ev.createBufferedFunction((key, inviteMessage) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
        ...
        })), communityGetInviteInfo: (code) => __awaiter(void 0, void 0, void 0, function* () {
            const results = yield communityQuery('@g.us', 'get', [{ tag: 'invite', attrs: { code } }]);
            return extractCommunityMetadata(results);
        }), communityToggleEphemeral: (jid, ephemeralExpiration) => __awaiter(void 0, void 0, void 0, function* () {
            const content = ephemeralExpiration
                ? { tag: 'ephemeral', attrs: { expiration: ephemeralExpiration.toString() } }
                : { tag: 'not_ephemeral', attrs: {} };
            yield communityQuery(jid, 'set', [content]);
        }), communitySettingUpdate: (jid, setting) => __awaiter(void 0, void 0, void 0, function* () {
            yield communityQuery(jid, 'set', [{ tag: setting, attrs: {} }]);
        }), communityMemberAddMode: (jid, mode) => __awaiter(void 0, void 0, void 0, function* () {
            yield communityQuery(jid, 'set', [{ tag: 'member_add_mode', attrs: {}, content: mode }]);
        }), communityJoinApprovalMode: (jid, mode) => __awaiter(void 0, void 0, void 0, function* () {
            yield communityQuery(jid, 'set', [
