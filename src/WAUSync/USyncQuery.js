...
import { USyncContactProtocol, USyncDeviceProtocol, USyncDisappearingModeProtocol, USyncStatusProtocol, USyncUsernameProtocol } from './Protocols';
                ...
                if (id) {
                    const data = Array.isArray(node === null || node === void 0 ? void 0 : node.content)
                        ? Object.fromEntries(node.content
                            ...
                            .filter(([, b]) => b !== null))
                        : {};
                    acc.push(Object.assign(Object.assign({}, data), { id }));
                }
                return acc;
            }, []);
        }
