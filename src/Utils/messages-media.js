...
export const getRawMediaUploadData = (media, mediaType, logger) =>
	__awaiter(void 0, void 0, void 0, function* () {
		var _a, e_1, _b, _c
...
export const extractImageThumb = (bufferOrFilePath_1, ...args_1) =>
	__awaiter(void 0, [bufferOrFilePath_1, ...args_1], void 0, function* (bufferOrFilePath, width = 32) {
		var _a, _b
...
export const generateProfilePicture = (mediaUpload, dimensions) =>
	__awaiter(void 0, void 0, void 0, function* () {
		var _a, _b
		let buffer
...
export const mediaMessageSHA256B64 = message => {
	...
	return (
		(media === null || media === void 0 ? void 0 : media.fileSha256) && Buffer.from(media.fileSha256).toString('base64')
	)
}
	...
	__awaiter(void 0, void 0, void 0, function* () {
		...
		try {
			for (
				...
				(stream_2_1 = yield stream_2.next()), (_b = stream_2_1.done), !_b;
				_a = true
			) {
				_d = stream_2_1.value
				_a = false
...
export const getStream = (item, opts) =>
	__awaiter(void 0, void 0, void 0, function* () {
...
export const getHttpStream = (url_1, ...args_1) =>
	__awaiter(void 0, [url_1, ...args_1], void 0, function* (url, options = {}) {
...
export const encryptedStream = (media_1, mediaType_1, ...args_1) =>
	__awaiter(
		void 0,
		[media_1, mediaType_1, ...args_1],
		void 0,
		function* (media, mediaType, { logger, saveOriginalFileIfRequired, opts } = {}) {
			var _a, e_3, _b, _c
			var _d, _e
			...
			try {
				try {
					for (
						var _f = true, stream_3 = __asyncValues(stream), stream_3_1;
						(stream_3_1 = yield stream_3.next()), (_a = stream_3_1.done), !_a;
						_f = true
					) {
						_c = stream_3_1.value
						_f = false
				...
				;(_d = originalFileStream === null || originalFileStream === void 0 ? void 0 : originalFileStream.end) ===
					null || _d === void 0
					? void 0
					: _d.call(originalFileStream)
				stream.destroy()
				...
				;(_e = originalFileStream === null || originalFileStream === void 0 ? void 0 : originalFileStream.destroy) ===
					null || _e === void 0
					? void 0
					: _e.call(originalFileStream)
				aes.destroy()
				hmac.destroy()
				sha256Plain.destroy()
				sha256Enc.destroy()
...
export const downloadContentFromMessage = (_a, type_1, ...args_1) =>
	__awaiter(void 0, [_a, type_1, ...args_1], void 0, function* ({ mediaKey, directPath, url }, type, opts = {}) {
 ...
 * */
export const downloadEncryptedContent = (downloadUrl_1, _a, ...args_1) =>
	__awaiter(
		void 0,
		[downloadUrl_1, _a, ...args_1],
		void 0,
		function* (downloadUrl, { cipherKey, iv }, { startByte, endByte, options } = {}) {
			let bytesFetched = 0
			let startChunk = 0
			...
			const headersInit = (options === null || options === void 0 ? void 0 : options.headers)
				? options.headers
				: undefined
...
export function extensionForMediaMessage(message) {
	const getExtension = mimetype => {
		var _a
		return (_a = mimetype.split(';')[0]) === null || _a === void 0 ? void 0 : _a.split('/')[1]
	}
...
export const uploadWithNodeHttp = (_a, ...args_1) =>
	__awaiter(
		void 0,
		[_a, ...args_1],
		void 0,
		function* ({ url, filePath, headers, timeoutMs, agent }, redirectCount = 0) {
			if (redirectCount > 5) {
...
const uploadWithFetch = _a =>
	__awaiter(void 0, [_a], void 0, function* ({ url, filePath, headers, timeoutMs, agent }) {
 ...
 */
const uploadMedia = (params, logger) =>
	__awaiter(void 0, void 0, void 0, function* () {
		if (isNodeRuntime()) {
...
export const getWAUploadToServer = ({ customUploadHosts, fetchAgent, logger, options }, refreshMediaConn) => {
	return (filePath_1, _a) =>
		__awaiter(void 0, [filePath_1, _a], void 0, function* (filePath, { mediaType, fileEncSha256B64, timeoutMs }) {
			var _b
			...
			const headers = Object.assign(Object.assign({}, customHeaders), {
			...
			for (const { hostname } of hosts) {
				...
				try {
					...
					if (
						...
						(result === null || result === void 0 ? void 0 : result.direct_path)
					) {
						urls = {
							mediaUrl: result.url,
					...
					const isLast =
						hostname === ((_b = hosts[uploadInfo.hosts.length - 1]) === null || _b === void 0 ? void 0 : _b.hostname)
					logger.warn(
						{ trace: error === null || error === void 0 ? void 0 : error.stack, uploadResult: result },
