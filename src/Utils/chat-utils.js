...
export const encodeSyncdPatch = (_a, myAppStateKeyId_1, state_1, getAppStateSyncKey_1) => __awaiter(void 0, [_a, myAppStateKeyId_1, state_1, getAppStateSyncKey_1], void 0, function* ({ type, index, syncAction, apiVersion, operation }, myAppStateKeyId, state, getAppStateSyncKey) {
...
export const decodeSyncdMutations = (msgMutations, initialState, getAppStateSyncKey, onMutation, validateMacs) => __awaiter(void 0, void 0, void 0, function* () {
...
export const decodeSyncdPatch = (msg, name, initialState, getAppStateSyncKey, onMutation, validateMacs) => __awaiter(void 0, void 0, void 0, function* () {
    if (validateMacs) {
...
export const extractSyncdPatches = (result, options) => __awaiter(void 0, void 0, void 0, function* () {
...
export const downloadExternalBlob = (blob, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, e_1, _b, _c;
...
export const downloadExternalPatch = (blob, options) => __awaiter(void 0, void 0, void 0, function* () {
    const buffer = yield downloadExternalBlob(blob, options);
    const syncData = proto.SyncdMutations.decode(buffer);
    return syncData;
});
export const decodeSyncdSnapshot = (name_1, snapshot_1, getAppStateSyncKey_1, minimumVersionNumber_1, ...args_1) => __awaiter(void 0, [name_1, snapshot_1, getAppStateSyncKey_1, minimumVersionNumber_1, ...args_1], void 0, function* (name, snapshot, getAppStateSyncKey, minimumVersionNumber, validateMacs = true) {
    const newState = newLTHashState();
    newState.version = toNumber(snapshot.version.version);
    const mutationMap = {};
    const areMutationsRequired = typeof minimumVersionNumber === 'undefined' || newState.version > minimumVersionNumber;
    const { hash, indexValueMap } = yield decodeSyncdMutations(snapshot.records, newState, getAppStateSyncKey, areMutationsRequired
        ? mutation => {
            var _a;
...
export const decodePatches = (name_1, syncds_1, initial_1, getAppStateSyncKey_1, options_1, minimumVersionNumber_1, logger_1, ...args_1) => __awaiter(void 0, [name_1, syncds_1, initial_1, getAppStateSyncKey_1, options_1, minimumVersionNumber_1, logger_1, ...args_1], void 0, function* (name, syncds, initial, getAppStateSyncKey, options, minimumVersionNumber, logger, validateMacs = true) {
    ...
    for (const syncd of syncds) {
        ...
        const decodeResult = yield decodeSyncdPatch(syncd, name, newState, getAppStateSyncKey, shouldMutate
            ? mutation => {
                var _a;
                const index = (_a = mutation.syncAction.index) === null || _a === void 0 ? void 0 : _a.toString();
                mutationMap[index] = mutation;
...
export const processSyncAction = (syncAction, ev, me, initialSyncOpts, logger) => {
    ...
    if (action === null || action === void 0 ? void 0 : action.muteAction) {
        ev.emit('chats.update', [
            {
                id,
                muteEndTime: ((_a = action.muteAction) === null || _a === void 0 ? void 0 : _a.muted) ? toNumber(action.muteAction.muteEndTimestamp) : null,
    ...
    else if ((_e = action === null || action === void 0 ? void 0 : action.localeSetting) === null || _e === void 0 ? void 0 : _e.locale) {
    ...
    else if ((_f = action === null || action === void 0 ? void 0 : action.notificationActivitySettingAction) === null || _f === void 0 ? void 0 : _f.notificationActivitySetting) {
        ev.emit('settings.update', {
    ...
    else if (action === null || action === void 0 ? void 0 : action.privacySettingChannelsPersonalisedRecommendationAction) {
        ev.emit('settings.update', {
