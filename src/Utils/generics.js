...
export const getKeyAuthor = (key, meId = 'me') =>
	((key === null || key === void 0 ? void 0 : key.fromMe)
		? meId
		: (key === null || key === void 0 ? void 0 : key.participantAlt) ||
			(key === null || key === void 0 ? void 0 : key.remoteJidAlt) ||
 ...
 */
export const fetchLatestBaileysVersion = (...args_1) =>
	__awaiter(void 0, [...args_1], void 0, function* (options = {}) {
 ...
 * Use to ensure your WA connection is always on the latest version
 */
export const fetchLatestWaWebVersion = (...args_1) =>
	__awaiter(void 0, [...args_1], void 0, function* (options = {}) {
		try {
			...
			const response = yield fetch(
				...
				Object.assign(Object.assign({}, options), { method: 'GET', headers })
			)
			if (!response.ok) {
