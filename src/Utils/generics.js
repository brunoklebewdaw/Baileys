...
export const getKeyAuthor = (key, meId = 'me') => ((key === null || key === void 0 ? void 0 : key.fromMe) ? meId : (key === null || key === void 0 ? void 0 : key.participantAlt) || (key === null || key === void 0 ? void 0 : key.remoteJidAlt) || (key === null || key === void 0 ? void 0 : key.participant) || (key === null || key === void 0 ? void 0 : key.remoteJid)) || '';
    ...
    return (check, timeoutMs) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield promiseTimeout(timeoutMs, (resolve, reject) => {
            closeListener = ({ connection, lastDisconnect }) => {
                if (connection === 'close') {
                    reject((lastDisconnect === null || lastDisconnect === void 0 ? void 0 : lastDisconnect.error) || new Boom('Connection Closed', { statusCode: DisconnectReason.connectionClosed }));
                }
            };
            ev.on('connection.update', closeListener);
            listener = (update) => __awaiter(this, void 0, void 0, function* () {
                if (yield check(update)) {
                    resolve();
                }
            });
 ...
 */
export const fetchLatestBaileysVersion = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (options = {}) {
 ...
 * Use to ensure your WA connection is always on the latest version
 */
export const fetchLatestWaWebVersion = (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (options = {}) {
    try {
        ...
        const response = yield fetch('https://web.whatsapp.com/sw.js', Object.assign(Object.assign({}, options), { method: 'GET', headers }));
        if (!response.ok) {
