...
function storeTcTokensFromHistorySync(chats, signalRepository, keyStore, logger) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		for (const c of candidates) {
			...
			const existingTs = (existingEntry === null || existingEntry === void 0 ? void 0 : existingEntry.timestamp)
				? Number(existingEntry.timestamp)
				: 0
			if (existingTs > 0 && existingTs >= c.ts) {
				continue
			}
			entries[c.storageJid] = Object.assign(
				Object.assign(Object.assign({}, existingEntry), { token: c.token, timestamp: String(c.ts) }),
...
export const cleanMessage = (message, meId, meLid) => {
	...
	if (isHostedPnUser(message.key.remoteJid) || isHostedLidUser(message.key.remoteJid)) {
		message.key.remoteJid = jidEncode(
			(_b = jidDecode((_a = message.key) === null || _a === void 0 ? void 0 : _a.remoteJid)) === null || _b === void 0
				? void 0
				: _b.user,
	...
	if (isHostedPnUser(message.key.participant) || isHostedLidUser(message.key.participant)) {
		message.key.participant = jidEncode(
			(_c = jidDecode(message.key.participant)) === null || _c === void 0 ? void 0 : _c.user,
...
const processMessage = (message_1, _a) =>
	__awaiter(
		void 0,
		[message_1, _a],
		void 0,
		function* (
			...
			if (
				(isRealMsg ||
					((_c =
						(_b = content === null || content === void 0 ? void 0 : content.reactionMessage) === null || _b === void 0
							? void 0
			...
			if (protocolMsg) {
				switch (protocolMsg.type) {
							...
							if ((_e = data.lidPnMappings) === null || _e === void 0 ? void 0 : _e.length) {
								...
								yield signalRepository.lidMapping
									...
									.catch(err =>
										logger === null || logger === void 0
											? void 0
											: logger.warn({ err }, 'failed to store LID-PN mappings from history sync')
									)
							}
					...
					case proto.Message.ProtocolMessage.Type.PEER_DATA_OPERATION_REQUEST_RESPONSE_MESSAGE:
						...
						if (response) {
							...
							for (const result of peerDataOperationResult) {
								const retryResponse =
									result === null || result === void 0 ? void 0 : result.placeholderMessageResendResponse
								//eslint-disable-next-line max-depth
								if (
									!(retryResponse === null || retryResponse === void 0 ? void 0 : retryResponse.webMessageInfoBytes)
								) {
									continue
								}
								//eslint-disable-next-line max-depth
								try {
									...
									const cachedData = msgId
										? yield placeholderResendCache === null || placeholderResendCache === void 0
												? void 0
												: placeholderResendCache.get(msgId)
										: undefined
									//eslint-disable-next-line max-depth
									if (msgId) {
										yield placeholderResendCache === null || placeholderResendCache === void 0
						...
						ev.emit('messages.update', [
							{
								...
								key: Object.assign(Object.assign({}, message.key), {
									id: (_g = protocolMsg.key) === null || _g === void 0 ? void 0 : _g.id
								}),
								update: {
									message: {
										editedMessage: {
					...
					case proto.Message.ProtocolMessage.Type.LID_MIGRATION_MAPPING_SYNC:
						const encodedPayload =
							(_h = protocolMsg.lidMigrationMappingSyncMessage) === null || _h === void 0
								? void 0
								: _h.encodedMappingPayload
				...
				if (eventMsg) {
					try {
						...
						const eventEncKey =
							(_k = eventMsg === null || eventMsg === void 0 ? void 0 : eventMsg.messageContextInfo) === null ||
							_k === void 0
								? void 0
								: _k.messageSecret
						if (!eventEncKey) {
				...
				const emitGroupUpdate = update => {
					...
					ev.emit('groups.update', [
						Object.assign(Object.assign({ id: jid }, update), {
							author: (_a = message.key.participant) !== null && _a !== void 0 ? _a : undefined,
							authorPn: message.key.participantAlt,
							authorUsername: message.key.participantUsername
						})
					])
				...
				switch (message.messageStubType) {
					...
					case WAMessageStubType.GROUP_MEMBERSHIP_JOIN_APPROVAL_REQUEST_NON_ADMIN_ADD: // TODO: Add other events
						const participant = JSON.parse(
							(_u = message.messageStubParameters) === null || _u === void 0 ? void 0 : _u[0]
						)
