 ...
 * */
export const useMultiFileAuthState = (folder) => __awaiter(void 0, void 0, void 0, function* () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const writeData = (data, file) => __awaiter(void 0, void 0, void 0, function* () {
        const filePath = join(folder, fixFileName(file));
        const mutex = getFileLock(filePath);
        return mutex.acquire().then((release) => __awaiter(void 0, void 0, void 0, function* () {
            try {
    ...
    const readData = (file) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const filePath = join(folder, fixFileName(file));
            const mutex = getFileLock(filePath);
            return yield mutex.acquire().then((release) => __awaiter(void 0, void 0, void 0, function* () {
                try {
