...
export const getDecryptionJid = (sender, repository) =>
...
const storeMappingFromEnvelope = (stanza, sender, repository, decryptionJid, logger) =>
	__awaiter(void 0, void 0, void 0, function* () {
...
export const extractAddressingContext = stanza => {
	...
	const addressingMode =
		...
		((sender === null || sender === void 0 ? void 0 : sender.endsWith('lid')) ? 'lid' : 'pn')
...
export function decodeMessageNode(stanza, meId, meLid) {
	...
	const pushname =
		(_a = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null || _a === void 0 ? void 0 : _a.notify
