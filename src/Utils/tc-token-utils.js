...
export function readTcTokenIndex(keys) {
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (
			!((_a = entry === null || entry === void 0 ? void 0 : entry.token) === null || _a === void 0 ? void 0 : _a.length)
		)
			return []
		try {
	...
	return __awaiter(this, arguments, void 0, function* ({ authState, jid, baseContent = [], getLIDForPN }) {
		try {
			...
			if (
				...
				isTcTokenExpired(entry === null || entry === void 0 ? void 0 : entry.timestamp)
			) {
				if (tcTokenBuffer) {
					...
					const cleared =
						(entry === null || entry === void 0 ? void 0 : entry.senderTimestamp) !== undefined
...
export function storeTcTokensFromIqResult(_a) {
	return __awaiter(this, arguments, void 0, function* ({ result, fallbackJid, keys, getLIDForPN, onNewJidStored }) {
		...
		for (const tokenNode of tokenNodes) {
			...
			yield keys.set({
				tctoken: {
					[storageJid]: Object.assign(Object.assign({}, existingEntry), {
