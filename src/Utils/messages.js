 ...
 */
export const extractUrlFromText = (text) => { var _a; return (_a = text.match(URL_REGEX)) === null || _a === void 0 ? void 0 : _a[0]; };
export const generateLinkPreviewIfRequired = (text, getUrlInfo, logger) => __awaiter(void 0, void 0, void 0, function* () {
...
export const prepareWAMessageMedia = (message, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isNewsletter) {
        ...
        const { filePath, fileSha256, fileLength } = yield getRawMediaUploadData(uploadData.media, options.mediaTypeOverride || mediaType, logger);
        ...
        const obj = WAProto.Message.fromObject({
            ...
            [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject(Object.assign(Object.assign({ url: mediaUrl, directPath,
                fileSha256,
                fileLength }, uploadData), { media: undefined }))
        });
        if (uploadData.ptv) {
    ...
    const { mediaKey, encFilePath, originalFilePath, fileEncSha256, fileSha256, fileLength } = yield encryptedStream(uploadData.media, options.mediaTypeOverride || mediaType, {
        logger,
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            try {
                if (requiresThumbnailComputation) {
                    const { thumbnail, originalImageDimensions } = yield generateThumbnail(originalFilePath, mediaType, options);
    ...
    const obj = WAProto.Message.fromObject({
        [`${mediaType}Message`]: MessageTypeProto[mediaType].fromObject(Object.assign(Object.assign({ url: mediaUrl, directPath,
            ...
            fileEncSha256,
            fileSha256,
            fileLength, mediaKeyTimestamp: unixTimestampSeconds() }, uploadData), { media: undefined }))
    });
    if (uploadData.ptv) {
        obj.ptvMessage = obj.videoMessage;
        delete obj.videoMessage;
...
export const generateForwardMessageContent = (message, forceForward) => {
    ...
    let score = ((_b = (_a = content === null || content === void 0 ? void 0 : content[key]) === null || _a === void 0 ? void 0 : _a.contextInfo) === null || _b === void 0 ? void 0 : _b.forwardingScore) || 0;
...
export const generateWAMessageContent = (message, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    var _f, _g;
    let m = {};
    if (hasNonNullishProperty(message, 'text')) {
        ...
        if (options.getProfilePicUrl) {
            ...
            if (pfpUrl) {
                const resp = yield fetch(pfpUrl, { method: 'GET', dispatcher: (_a = options === null || options === void 0 ? void 0 : options.options) === null || _a === void 0 ? void 0 : _a.dispatcher });
                if (resp.ok) {
        ...
        m.productMessage = WAProto.Message.ProductMessage.create(Object.assign(Object.assign({}, message), { product: Object.assign(Object.assign({}, message.product), { productImage: imageMessage }) }));
    }
    ...
    if ((hasOptionalProperty(message, 'mentions') && ((_d = message.mentions) === null || _d === void 0 ? void 0 : _d.length)) ||
...
export const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !isJidNewsletter(jid)) {
        ...
        const contextInfo = ('contextInfo' in innerMessage[key] && ((_a = innerMessage[key]) === null || _a === void 0 ? void 0 : _a.contextInfo)) || {};
    ...
    !!(options === null || options === void 0 ? void 0 : options.ephemeralExpiration) &&
        ...
        !isJidNewsletter(jid)) {
        /* @ts-ignore */
        innerMessage[key].contextInfo = Object.assign(Object.assign({}, (innerMessage[key].contextInfo || {})), { expiration: options.ephemeralExpiration || WA_DEFAULT_EPHEMERAL });
    }
...
export const generateWAMessage = (jid, content, options) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    // ensure msg ID is with every log
    options.logger = (_a = options === null || options === void 0 ? void 0 : options.logger) === null || _a === void 0 ? void 0 : _a.child({ msgId: options.messageId });
    // Pass jid in the options to generateWAMessageContent
    return generateWAMessageFromContent(jid, yield generateWAMessageContent(content, Object.assign(Object.assign({}, options), { jid })), options);
});
 ...
 */
export const downloadMediaMessage = (message, type, options, ctx) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield downloadMsg().catch((error) => __awaiter(void 0, void 0, void 0, function* () {
        if (ctx &&
