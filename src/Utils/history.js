...
const extractPnFromMessages = messages => {
	...
	for (const msgItem of messages) {
		...
		if (
			!((_a = message === null || message === void 0 ? void 0 : message.key) === null || _a === void 0
				? void 0
				: _a.fromMe) ||
			!((_b = message.userReceipt) === null || _b === void 0 ? void 0 : _b.length)
		) {
			continue
		}
...
export const downloadHistory = (msg, options) =>
...
export const processHistoryMessage = (item, logger) => {
	...
	logger === null || logger === void 0
		...
		: logger.trace(
				...
				'processing history of type ' + ((_a = item.syncType) === null || _a === void 0 ? void 0 : _a.toString())
			)
...
export const downloadAndProcessHistorySyncNotification = (msg, options, logger) =>
	__awaiter(void 0, void 0, void 0, function* () {
		let historyMsg
...
export const getHistoryMsg = message => {
	...
	const anyHistoryMsg =
		(_a = normalizedContent === null || normalizedContent === void 0 ? void 0 : normalizedContent.protocolMessage) ===
			null || _a === void 0
			? void 0
