...
export const generateLoginNode = (userJid, config) => {
    ...
    const payload = Object.assign(Object.assign({}, getClientPayload(config)), { passive: true, pull: true, username: +user, device: device, 
...
export const generateRegistrationNode = ({ registrationId, signedPreKey, signedIdentityKey }, config) => {
    ...
    const registerPayload = Object.assign(Object.assign({}, getClientPayload(config)), { passive: false, pull: false, devicePairingData: {
