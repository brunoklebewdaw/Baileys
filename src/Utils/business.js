...
export function uploadingNecessaryImagesOfProduct(product_1, waUploadToServer_1) {
    return __awaiter(this, arguments, void 0, function* (product, waUploadToServer, timeoutMs = 30000) {
        product = Object.assign(Object.assign({}, product), { images: product.images
 ...
 * Uploads images not already uploaded to WA's servers
 */
export const uploadingNecessaryImages = (images_1, waUploadToServer_1, ...args_1) => __awaiter(void 0, [images_1, waUploadToServer_1, ...args_1], void 0, function* (images, waUploadToServer, timeoutMs = 30000) {
