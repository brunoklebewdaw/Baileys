...
export const makeNoiseHandler = ({ keyPair: { private: privateKey, public: publicKey }, NOISE_HEADER, logger, routingInfo }) => {
    ...
    const finishInit = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (pendingOnFrame) {
            ...
            yield processData(pendingOnFrame);
            pendingOnFrame = null;
        }
    });
    const processData = (onFrame) => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        let size;
        while (true) {
            if (inBytes.length < 3)
            ...
            if (transport) {
                ...
                frame = yield decodeBinaryNode(result);
            }
    ...
    return {
        ...
        processHandshake: ({ serverHello }, noiseKey) => {
            ...
            // leaf
            if (!(leaf === null || leaf === void 0 ? void 0 : leaf.details) || !(leaf === null || leaf === void 0 ? void 0 : leaf.signature)) {
                throw new Boom('invalid noise leaf certificate', { statusCode: 400 });
            }
            if (!(certIntermediate === null || certIntermediate === void 0 ? void 0 : certIntermediate.details) || !(certIntermediate === null || certIntermediate === void 0 ? void 0 : certIntermediate.signature)) {
        ...
        decodeFrame: (newData, onFrame) => __awaiter(void 0, void 0, void 0, function* () {
