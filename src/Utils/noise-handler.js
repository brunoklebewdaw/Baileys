...
export const makeNoiseHandler = ({
			...
			while (true) {
				...
				if (logger.level === 'trace') {
					logger.trace(
						{
							msg:
								(_a = frame === null || frame === void 0 ? void 0 : frame.attrs) === null || _a === void 0
									? void 0
									: _a.id
						},
						'recv frame'
	...
	return {
		...
		processHandshake: ({ serverHello }, noiseKey) => {
			...
			// leaf
			if (
				!(leaf === null || leaf === void 0 ? void 0 : leaf.details) ||
				!(leaf === null || leaf === void 0 ? void 0 : leaf.signature)
			) {
				throw new Boom('invalid noise leaf certificate', { statusCode: 400 })
			}
			if (
				!(certIntermediate === null || certIntermediate === void 0 ? void 0 : certIntermediate.details) ||
				!(certIntermediate === null || certIntermediate === void 0 ? void 0 : certIntermediate.signature)
			) {
