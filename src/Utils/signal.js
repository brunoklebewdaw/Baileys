...
export const getPreKeys = (_a, min_1, limit_1) =>
	__awaiter(void 0, [_a, min_1, limit_1], void 0, function* ({ get }, min, limit) {
		const idList = []
...
export const parseAndInjectE2ESessions = (node, repository) =>
 ...
 */
export const getNextPreKeys = (_a, count_1) =>
	__awaiter(void 0, [_a, count_1], void 0, function* ({ creds, keys }, count) {
...
export const getNextPreKeysNode = (state, count) =>
	__awaiter(void 0, void 0, void 0, function* () {
		const { creds } = state
