...
export class LIDMappingStore {
    ...
    storeLIDPNMappings(pairs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.keys.transaction(() => __awaiter(this, void 0, void 0, function* () {
    ...
    getLIDForPN(pn) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            return ((_b = (_a = (yield this.getLIDsForPNs([pn]))) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.lid) || null;
        });
    }
    getLIDsForPNs(pns) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _getLIDsForPNsImpl(pns) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Object.keys(usyncFetch).length > 0) {
                const result = yield ((_b = this.pnToLIDFunc) === null || _b === void 0 ? void 0 : _b.call(this, Object.keys(usyncFetch))); // this function already adds LIDs to mapping
    ...
    getPNForLID(lid) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            return ((_b = (_a = (yield this.getPNsForLIDs([lid]))) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.pn) || null;
        });
    }
    getPNsForLIDs(lids) {
        return __awaiter(this, void 0, void 0, function* () {
