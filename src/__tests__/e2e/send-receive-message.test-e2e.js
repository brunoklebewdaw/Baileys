...
describe('E2E Tests', () => {
			...
			yield new Promise((resolve, reject) => {
				sock.ev.on('connection.update', update => {
					...
					if (connection === 'open') {
						...
						const reason =
							(_d =
								(_c = lastDisconnect === null || lastDisconnect === void 0 ? void 0 : lastDisconnect.error) === null ||
								_c === void 0
									? void 0
									: _c.output) === null || _d === void 0
								? void 0
								: _d.statusCode
	...
	test('should send a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			expect(
				((_b = (_a = sentMessage.message) === null || _a === void 0 ? void 0 : _a.extendedTextMessage) === null ||
				_b === void 0
					? void 0
					: _b.text) || ((_c = sentMessage.message) === null || _c === void 0 ? void 0 : _c.conversation)
			).toBe(messageContent)
		}))
	test('should edit a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			expect(
				(_b = (_a = editedMessage.message) === null || _a === void 0 ? void 0 : _a.protocolMessage) === null ||
					_b === void 0
					? void 0
					: _b.type
			).toBe(proto.Message.ProtocolMessage.Type.MESSAGE_EDIT)
			const editedContent =
				(_d = (_c = editedMessage.message) === null || _c === void 0 ? void 0 : _c.protocolMessage) === null ||
				_d === void 0
					? void 0
					: _d.editedMessage
			expect(
				((_e = editedContent === null || editedContent === void 0 ? void 0 : editedContent.extendedTextMessage) ===
					null || _e === void 0
					? void 0
					: _e.text) || (editedContent === null || editedContent === void 0 ? void 0 : editedContent.conversation)
			).toBe(newContent)
		}))
	test('should react to a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c, _d, _e
			...
			expect(
				(_b = (_a = reactionMessage.message) === null || _a === void 0 ? void 0 : _a.reactionMessage) === null ||
					_b === void 0
					? void 0
					: _b.text
			).toBe(reaction)
			expect(
				(_e =
					(_d = (_c = reactionMessage.message) === null || _c === void 0 ? void 0 : _c.reactionMessage) === null ||
					_d === void 0
						? void 0
						: _d.key) === null || _e === void 0
					? void 0
					: _e.id
			).toBe(sentMessage.key.id)
		}))
	test('should remove a reaction from a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c, _d, _e
			...
			expect(
				(_b = (_a = removeReactionMessage.message) === null || _a === void 0 ? void 0 : _a.reactionMessage) === null ||
					_b === void 0
					? void 0
					: _b.text
			).toBe('')
			expect(
				(_e =
					(_d = (_c = removeReactionMessage.message) === null || _c === void 0 ? void 0 : _c.reactionMessage) ===
						null || _d === void 0
						? void 0
						: _d.key) === null || _e === void 0
					? void 0
	...
	test('should delete a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			expect(
				(_b = (_a = deleteMessage.message) === null || _a === void 0 ? void 0 : _a.protocolMessage) === null ||
					_b === void 0
					? void 0
					: _b.type
			).toBe(proto.Message.ProtocolMessage.Type.REVOKE)
			expect(
				(_e =
					(_d = (_c = deleteMessage.message) === null || _c === void 0 ? void 0 : _c.protocolMessage) === null ||
					_d === void 0
						? void 0
						: _d.key) === null || _e === void 0
					? void 0
	...
	test('should forward a message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			...
			const content =
				((_b = (_a = forwardedMessage.message) === null || _a === void 0 ? void 0 : _a.extendedTextMessage) === null ||
				_b === void 0
					? void 0
					: _b.text) || ((_c = forwardedMessage.message) === null || _c === void 0 ? void 0 : _c.conversation)
			expect(content).toBe(messageContent)
			expect(forwardedMessage.key.id).not.toBe(sentMessage.key.id)
		}))
	test('should send an image message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			...
			expect(
				(_c = (_b = sentMessage.message) === null || _b === void 0 ? void 0 : _b.imageMessage) === null || _c === void 0
					? void 0
					: _c.caption
			).toBe('E2E Test Image')
		}))
	test('should send a video message with a thumbnail', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			...
			expect(
				(_c = (_b = sentMessage.message) === null || _b === void 0 ? void 0 : _b.videoMessage) === null || _c === void 0
					? void 0
					: _c.caption
			).toBe('E2E Test Video')
		}))
	test('should send a PTT (push-to-talk) audio message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			...
			expect(
				(_c = (_b = sentMessage.message) === null || _b === void 0 ? void 0 : _b.audioMessage) === null || _c === void 0
					? void 0
					: _c.ptt
			).toBe(true)
		}))
	test('should send a document message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			...
			expect(
				(_c = (_b = sentMessage.message) === null || _b === void 0 ? void 0 : _b.documentMessage) === null ||
					_c === void 0
					? void 0
					: _c.fileName
			).toBe('E2E Test Document.pdf')
		}))
	test('should send a sticker message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
	...
	test('should send a poll message and receive a vote', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			const poll = {
				name: 'E2E Test Poll',
			...
			expect(
				(_a = sentPoll === null || sentPoll === void 0 ? void 0 : sentPoll.message) === null || _a === void 0
					? void 0
					: _a.pollCreationMessageV3
			).toBeDefined()
			expect(
				(_c =
					(_b = sentPoll === null || sentPoll === void 0 ? void 0 : sentPoll.message) === null || _b === void 0
						? void 0
						: _b.pollCreationMessageV3) === null || _c === void 0
					? void 0
					: _c.name
			).toBe('E2E Test Poll')
		}))
	test('should send a contact (vCard) message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			const vcard =
				'BEGIN:VCARD\n' +
			...
			expect(
				(_c = (_b = sentMessage.message) === null || _b === void 0 ? void 0 : _b.contactMessage) === null ||
					_c === void 0
					? void 0
					: _c.vcard
			).toContain('FN:E2E Test Contact')
		}))
	test('should send and download an image message', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const image = readFileSync('./Media/cat.jpeg')
			...
			try {
				const receivedMsgPromise = new Promise((resolve, reject) => {
					listener = ({ messages }) => {
						const msg = messages.find(m => {
							var _a, _b
							return (
								((_b = (_a = m.message) === null || _a === void 0 ? void 0 : _a.imageMessage) === null || _b === void 0
									? void 0
									: _b.caption) === caption
							)
						})
				...
				const buffer = yield downloadMediaMessage(
					receivedMsg,
					'buffer',
					{},
					{
	...
	test('should send and download an image message via LID', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	test('should send and download an image using the low-level downloadContentFromMessage', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a
			const image = readFileSync('./Media/cat.jpeg')
	...
	test('should download a quoted image message using downloadContentFromMessage', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			const image = readFileSync('./Media/cat.jpeg')
			...
			try {
				...
				const receivedCommandPromise = new Promise((resolve, reject) => {
					commandListener = ({ messages }) => {
						const msg = messages.find(m => {
							var _a, _b
							return (
								((_b = (_a = m.message) === null || _a === void 0 ? void 0 : _a.extendedTextMessage) === null ||
								_b === void 0
									? void 0
									: _b.text) === commandText
							)
				...
				const quotedMessage =
					(_c =
						(_b = (_a = receivedCommandMessage.message) === null || _a === void 0 ? void 0 : _a.extendedTextMessage) ===
							null || _b === void 0
							? void 0
							: _b.contextInfo) === null || _c === void 0
						? void 0
						: _c.quotedMessage
	...
	test('should download a quoted videos message within a group', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			var _a, _b, _c
			if (!groupJid) {
					...
					videoListener = ({ messages }) => {
						const msg = messages.find(m => {
							...
							return (
								...
								((_b = (_a = m.message) === null || _a === void 0 ? void 0 : _a.videoMessage) === null || _b === void 0
									? void 0
									: _b.caption) === originalCaption
							)
						})
