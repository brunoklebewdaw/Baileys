...
describe('fetchLatestWaWebVersion Integration Tests', () => {
    ...
    it('should successfully fetch the latest WhatsApp Web version from real API', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle custom headers correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        const customHeaders = {
    ...
    it('should fallback gracefully when client_revision is not found', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield fetchLatestWaWebVersion();
        expect(result).toHaveProperty('version');
        expect(result).toHaveProperty('isLatest');
        expect(Array.isArray(result.version)).toBe(true);
    }));
    it('should handle network timeouts gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield fetchLatestWaWebVersion();
        expect(result).toHaveProperty('version');
        expect(result).toHaveProperty('isLatest');
        expect(Array.isArray(result.version)).toBe(true);
