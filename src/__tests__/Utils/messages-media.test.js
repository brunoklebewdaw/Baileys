...
const createTempFile = (content) => __awaiter(void 0, void 0, void 0, function* () {
...
describe('uploadWithNodeHttp', () => {
    ...
    it('should successfully upload a file and receive JSON response', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should follow a single redirect (302)', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should follow multiple redirects (301 -> 302 -> 200)', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should throw error on too many redirects (more than 5)', () => __awaiter(void 0, void 0, void 0, function* () {
        yield startServer((req, res) => {
            var _a;
            const currentNum = parseInt(((_a = req.url) === null || _a === void 0 ? void 0 : _a.replace('/redirect', '')) || '0');
    ...
    it('should return undefined for non-JSON response', () => __awaiter(void 0, void 0, void 0, function* () {
        yield startServer((req, res) => {
            let body = '';
            req.on('data', chunk => (body += chunk));
            req.on('end', () => {
    ...
    it('should handle relative redirect URLs', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should preserve headers on redirect', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield uploadWithNodeHttp(params);
        expect(result).toEqual(expectedResponse);
        expect(capturedHeaders === null || capturedHeaders === void 0 ? void 0 : capturedHeaders['x-custom-header']).toBe('test-value');
        expect(capturedHeaders === null || capturedHeaders === void 0 ? void 0 : capturedHeaders['authorization']).toBe('Bearer token123');
    }));
    it('should re-stream file content on redirect', () => __awaiter(void 0, void 0, void 0, function* () {
        const expectedResponse = { success: true };
...
describe('encryptedStream', () => {
    const cleanupFiles = (files) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should encrypt a buffer and return valid result without hanging', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should encrypt a stream and complete without race condition', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should save original file when saveOriginalFileIfRequired is true', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should complete encryption for various media types', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle empty buffer without hanging', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should handle small content that finishes quickly', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should complete multiple concurrent encryptions without deadlock', () => __awaiter(void 0, void 0, void 0, function* () {
