...
describe('App State Sync', () => {
	describe('missing key errors are marked with isMissingKey (Blocked in WA Web)', () => {
		it('decodeSyncdPatch throws with isMissingKey on missing key', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const msg = {
		...
		it('decodeSyncdSnapshot throws with isMissingKey on missing snapshot key', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const snapshot = {
					version: { version: 1 },
					records: [],
		...
		it('decodeSyncdMutations throws with isMissingKey on missing mutation key', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const records = [
					{
						keyId: { id: Buffer.from('missing-key') },
