...
describe('storeTcTokensFromIqResult', () => {
				...
				content: [
					{
						tag: 'token',
						attrs: Object.assign(
							Object.assign({ type: 'trusted_contact' }, tokenJid ? { jid: tokenJid } : {}),
	...
	it('stores token under fallbackJid even when token node has a different jid attr', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('multiple notifications from different contacts do NOT overwrite each other', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('uses fallbackJid when token node has no jid attr', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('resolves fallbackJid to LID via getLIDForPN', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS)
	...
	it('calls onNewJidStored with the resolved storage JID', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS)
	...
	it.each([
		...
		['group', 'abc-def@g.us']
	])('skips storage for non-regular user (%s)', (_label, fallbackJid) =>
		__awaiter(void 0, void 0, void 0, function* () {
			const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS)
			yield storeTcTokensFromIqResult({
				result: node,
	...
	it('skips token nodes with non-trusted_contact type', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const node = {
				tag: 'notification',
	...
	it('respects timestamp monotonicity guard', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('does not overwrite timestamped entry with timestamp-less token', () =>
		__awaiter(void 0, void 0, void 0, function* () {
...
describe('buildTcTokenFromJid', () => {
	...
	it('returns tctoken node for valid non-expired token', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
	...
	it('deletes expired token from store (Phase 5 opportunistic cleanup)', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: EXPIRED_TS } })
	...
	it('preserves senderTimestamp when clearing an expired peer token', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('does NOT delete when token is simply missing', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({})
			yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID })
	...
	it('appends tctoken to existing baseContent', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: RECENT_TS } })
			const existingNode = { tag: 'picture', attrs: { type: 'image' } }
	...
	it('handles key store errors gracefully', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
	...
	it('handles key store errors with baseContent fallback', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockRejectedValueOnce(new Error('database error'))
			const existingNode = { tag: 'picture', attrs: { type: 'image' } }
	...
	it('returns undefined when token has no timestamp (treated as expired)', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
...
describe('tctoken integration scenarios', () => {
	...
	describe('Phase 1: token fetch and store flow', () => {
		it('token missing → fetch stores new token → subsequent read finds it', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const recentTs = String(nowSeconds())
				// First read: no token
				// @ts-ignore
				mockKeys.get.mockResolvedValueOnce({})
				const result1 = yield buildTcTokenFromJid({
					authState: { keys: mockKeys },
					getLIDForPN: noopGetLID,
					jid: JID_A
				})
				...
				const result2 = yield buildTcTokenFromJid({
					authState: { keys: mockKeys },
					getLIDForPN: noopGetLID,
					jid: JID_A
				})
	...
	describe('Phase 2: expired token triggers re-fetch', () => {
		it('expired token is detected and deleted, then re-fetch stores fresh token', () =>
			__awaiter(void 0, void 0, void 0, function* () {
	...
	describe('Phase 4: identity change re-issuance decision', () => {
		it('re-issues when senderTimestamp is recent (within 28-day window)', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				var _a
		...
		it('does NOT re-issue when senderTimestamp is expired', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				var _a
		...
		it('does NOT re-issue when no senderTimestamp exists', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				var _a
				// @ts-ignore
	...
	describe('full lifecycle simulation', () => {
		...
		it('multiple contacts have independent token lifecycles', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const now = nowSeconds()
				// @ts-ignore
				mockKeys.get.mockResolvedValue({
...
describe('resolveIssuanceJid', () => {
	...
	it('resolves PN to LID when issueToLid=true', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('returns original JID when issueToLid=true but no LID mapping', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const getLIDForPN = jest.fn().mockResolvedValue(null)
			const result = yield resolveIssuanceJid(PN_JID, true, getLIDForPN)
			expect(result).toBe(PN_JID)
		}))
	it('returns LID as-is when issueToLid=true and already a LID', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('returns PN as-is when issueToLid=false and already a PN', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const getLIDForPN = jest.fn()
			const result = yield resolveIssuanceJid(PN_JID, false, getLIDForPN)
			expect(result).toBe(PN_JID)
		}))
	it('resolves LID to PN when issueToLid=false', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const getLIDForPN = jest.fn()
	...
	it('returns LID when issueToLid=false but no PN mapping', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			const getLIDForPN = jest.fn()
...
describe('tctoken index helpers', () => {
	...
	it('readTcTokenIndex returns empty array when no sentinel exists', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({})
			expect(yield readTcTokenIndex(mockKeys)).toEqual([])
		}))
	it('readTcTokenIndex parses persisted JIDs and drops the sentinel itself', () =>
		__awaiter(void 0, void 0, void 0, function* () {
	...
	it('readTcTokenIndex tolerates malformed payloads', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({
	...
	it('buildMergedTcTokenIndexWrite unions persisted and added JIDs', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({
	...
	it('buildMergedTcTokenIndexWrite filters out the sentinel key and empty strings', () =>
		__awaiter(void 0, void 0, void 0, function* () {
			// @ts-ignore
			mockKeys.get.mockResolvedValue({})
