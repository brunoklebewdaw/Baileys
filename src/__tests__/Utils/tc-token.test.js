...
import { buildMergedTcTokenIndexWrite, buildTcTokenFromJid, isTcTokenExpired, readTcTokenIndex, resolveIssuanceJid, shouldSendNewTcToken, storeTcTokensFromIqResult, TC_TOKEN_INDEX_KEY } from '../../Utils/tc-token-utils';
...
describe('storeTcTokensFromIqResult', () => {
    ...
    let mockKeys;
    const noopGetLID = () => __awaiter(void 0, void 0, void 0, function* () { return null; });
    beforeEach(() => {
        mockKeys = createMockKeys();
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
    });
    const makeNotificationNode = (tokenJid, tokenContent, timestamp) => ({
        tag: 'notification',
        ...
        content: [
            {
                ...
                content: [
                    {
                        tag: 'token',
                        attrs: Object.assign(Object.assign({ type: 'trusted_contact' }, (tokenJid ? { jid: tokenJid } : {})), (timestamp ? { t: timestamp } : {})),
    ...
    it('stores token under fallbackJid even when token node has a different jid attr', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('multiple notifications from different contacts do NOT overwrite each other', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const call1 = mockKeys.set.mock.calls[0][0];
        const call2 = mockKeys.set.mock.calls[1][0];
    ...
    it('uses fallbackJid when token node has no jid attr', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('resolves fallbackJid to LID via getLIDForPN', () => __awaiter(void 0, void 0, void 0, function* () {
        const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS);
        const getLIDForPN = jest.fn().mockResolvedValue(CONTACT_LID);
        yield storeTcTokensFromIqResult({
            result: node,
            fallbackJid: CONTACT_JID,
            keys: mockKeys,
    ...
    it('calls onNewJidStored with the resolved storage JID', () => __awaiter(void 0, void 0, void 0, function* () {
        const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS);
    ...
    it.each([
        ...
        ['group', 'abc-def@g.us']
    ])('skips storage for non-regular user (%s)', (_label, fallbackJid) => __awaiter(void 0, void 0, void 0, function* () {
        const node = makeNotificationNode(MY_DEVICE_JID, TOKEN_BYTES, RECENT_TS);
        yield storeTcTokensFromIqResult({
            result: node,
            fallbackJid,
    ...
    it('skips token nodes with non-trusted_contact type', () => __awaiter(void 0, void 0, void 0, function* () {
        const node = {
            tag: 'notification',
    ...
    it('respects timestamp monotonicity guard', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('does not overwrite timestamped entry with timestamp-less token', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('isTcTokenExpired', () => {
    ...
    it('returns true for null', () => {
        ...
        expect(isTcTokenExpired(null)).toBe(true);
    });
...
describe('buildTcTokenFromJid', () => {
    ...
    it('returns tctoken node for valid non-expired token', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: RECENT_TS } });
        const result = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
    ...
    it('returns undefined when no token exists', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
        const result = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
        expect(result).toBeUndefined();
    }));
    it('returns undefined for expired token', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: EXPIRED_TS } });
        const result = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
        expect(result).toBeUndefined();
    }));
    it('deletes expired token from store (Phase 5 opportunistic cleanup)', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: EXPIRED_TS } });
        yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
        expect(mockKeys.set).toHaveBeenCalledWith({ tctoken: { [TEST_JID]: null } });
    }));
    it('preserves senderTimestamp when clearing an expired peer token', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('does NOT delete when token is simply missing', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
        yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
        expect(mockKeys.set).not.toHaveBeenCalled();
    }));
    it('preserves baseContent when no token', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
        const existingNode = { tag: 'picture', attrs: { type: 'image' } };
        const result = yield buildTcTokenFromJid({
    ...
    it('appends tctoken to existing baseContent', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({ [TEST_JID]: { token: VALID_TOKEN, timestamp: RECENT_TS } });
        const existingNode = { tag: 'picture', attrs: { type: 'image' } };
        const result = yield buildTcTokenFromJid({
    ...
    it('handles key store errors gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockRejectedValueOnce(new Error('database error'));
        const result = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: TEST_JID });
        expect(result).toBeUndefined();
    }));
    it('handles key store errors with baseContent fallback', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockRejectedValueOnce(new Error('database error'));
        const existingNode = { tag: 'picture', attrs: { type: 'image' } };
        const result = yield buildTcTokenFromJid({
    ...
    it('returns undefined when token has no timestamp (treated as expired)', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
...
describe('tctoken integration scenarios', () => {
    ...
    describe('Phase 1: token fetch and store flow', () => {
        it('token missing → fetch stores new token → subsequent read finds it', () => __awaiter(void 0, void 0, void 0, function* () {
            const recentTs = String(nowSeconds());
            // First read: no token
            // @ts-ignore
            mockKeys.get.mockResolvedValueOnce({});
            const result1 = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: JID_A });
            expect(result1).toBeUndefined();
            // Simulate: after fetch, token is stored
            yield mockKeys.set({ tctoken: { [JID_A]: { token: TOKEN_A, timestamp: recentTs } } });
            expect(mockKeys.set).toHaveBeenCalledWith({
            ...
            const result2 = yield buildTcTokenFromJid({ authState: { keys: mockKeys }, getLIDForPN: noopGetLID, jid: JID_A });
    ...
    describe('Phase 2: expired token triggers re-fetch', () => {
        it('expired token is detected and deleted, then re-fetch stores fresh token', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('senderTimestamp preservation on token update', () => {
        it('simulates notification handler preserving senderTimestamp via spread', () => {
            ...
            const merged = Object.assign(Object.assign({}, existingEntry), { token: newToken, timestamp: newTimestamp });
        ...
        it('spread with undefined existing does not crash', () => {
            ...
            const existing = {}['unknown@lid'];
            // Spread of undefined is a no-op at runtime
            const merged = Object.assign(Object.assign({}, existing), { token: newToken, timestamp: newTimestamp });
            expect(merged.token).toBe(newToken);
            expect(merged.timestamp).toBe(newTimestamp);
    ...
    describe('Phase 4: identity change re-issuance decision', () => {
        it('re-issues when senderTimestamp is recent (within 28-day window)', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            ...
            const tcTokenData = yield mockKeys.get('tctoken', [JID_A]);
            const senderTs = (_a = tcTokenData[JID_A]) === null || _a === void 0 ? void 0 : _a.senderTimestamp;
            // Valid senderTimestamp → should re-issue
            expect(senderTs).toBeDefined();
            expect(isTcTokenExpired(senderTs)).toBe(false);
        }));
        it('does NOT re-issue when senderTimestamp is expired', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
        ...
        it('does NOT re-issue when no senderTimestamp exists', () => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            // @ts-ignore
    ...
    describe('full lifecycle simulation', () => {
        ...
        it('multiple contacts have independent token lifecycles', () => __awaiter(void 0, void 0, void 0, function* () {
            const now = nowSeconds();
            // @ts-ignore
            mockKeys.get.mockResolvedValue({
            ...
            const data = yield mockKeys.get('tctoken', [JID_A, JID_B]);
            // A is valid
    ...
    describe('tctoken index persistence', () => {
        ...
        it('index ignores sentinel key when loading', () => {
            const jids = [JID_A, INDEX_KEY, JID_B, '', null];
        ...
        it('index enables pruning of tokens from previous sessions', () => {
            ...
            for (const jid of knownJids) {
                ...
                if (!(entry === null || entry === void 0 ? void 0 : entry.token) || isTcTokenExpired(entry.timestamp)) {
...
describe('resolveIssuanceJid', () => {
    ...
    it('resolves PN to LID when issueToLid=true', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn().mockResolvedValue(LID_JID);
        const result = yield resolveIssuanceJid(PN_JID, true, getLIDForPN);
        expect(result).toBe(LID_JID);
    }));
    it('returns original JID when issueToLid=true but no LID mapping', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn().mockResolvedValue(null);
        const result = yield resolveIssuanceJid(PN_JID, true, getLIDForPN);
        expect(result).toBe(PN_JID);
    }));
    it('returns LID as-is when issueToLid=true and already a LID', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn();
        const result = yield resolveIssuanceJid(LID_JID, true, getLIDForPN);
        expect(result).toBe(LID_JID);
        expect(getLIDForPN).not.toHaveBeenCalled();
    }));
    it('returns PN as-is when issueToLid=false and already a PN', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn();
        const result = yield resolveIssuanceJid(PN_JID, false, getLIDForPN);
        expect(result).toBe(PN_JID);
    }));
    it('resolves LID to PN when issueToLid=false', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn();
        const getPNForLID = jest.fn().mockResolvedValue(PN_JID);
        const result = yield resolveIssuanceJid(LID_JID, false, getLIDForPN, getPNForLID);
        expect(result).toBe(PN_JID);
    }));
    it('returns LID when issueToLid=false but no PN mapping', () => __awaiter(void 0, void 0, void 0, function* () {
        const getLIDForPN = jest.fn();
        const getPNForLID = jest.fn().mockResolvedValue(null);
        const result = yield resolveIssuanceJid(LID_JID, false, getLIDForPN, getPNForLID);
        expect(result).toBe(LID_JID);
    }));
});
...
describe('tctoken index helpers', () => {
    ...
    it('readTcTokenIndex returns empty array when no sentinel exists', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
        expect(yield readTcTokenIndex(mockKeys)).toEqual([]);
    }));
    it('readTcTokenIndex parses persisted JIDs and drops the sentinel itself', () => __awaiter(void 0, void 0, void 0, function* () {
        const persisted = ['a@lid', 'b@lid', TC_TOKEN_INDEX_KEY];
        // @ts-ignore
        mockKeys.get.mockResolvedValue({
            [TC_TOKEN_INDEX_KEY]: { token: Buffer.from(JSON.stringify(persisted)) }
        });
        expect(yield readTcTokenIndex(mockKeys)).toEqual(['a@lid', 'b@lid']);
    }));
    it('readTcTokenIndex tolerates malformed payloads', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({
    ...
    it('buildMergedTcTokenIndexWrite unions persisted and added JIDs', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({
            [TC_TOKEN_INDEX_KEY]: { token: Buffer.from(JSON.stringify(['a@lid'])) }
        });
        const write = yield buildMergedTcTokenIndexWrite(mockKeys, ['b@lid', 'a@lid']);
        const merged = JSON.parse(write[TC_TOKEN_INDEX_KEY].token.toString());
        expect(new Set(merged)).toEqual(new Set(['a@lid', 'b@lid']));
    }));
    it('buildMergedTcTokenIndexWrite filters out the sentinel key and empty strings', () => __awaiter(void 0, void 0, void 0, function* () {
        // @ts-ignore
        mockKeys.get.mockResolvedValue({});
        const write = yield buildMergedTcTokenIndexWrite(mockKeys, [TC_TOKEN_INDEX_KEY, '', 'a@lid']);
        const merged = JSON.parse(write[TC_TOKEN_INDEX_KEY].token.toString());
