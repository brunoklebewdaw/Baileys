...
describe('parseAndInjectE2ESessions', () => {
    it('should process all user node', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(mockRepository.injectE2ESession).toHaveBeenCalledWith(expect.objectContaining({ jid: 'user1@s.whatsapp.net' }));
        expect(mockRepository.injectE2ESession).toHaveBeenCalledWith(expect.objectContaining({ jid: 'user2@s.whatsapp.net' }));
        expect(mockRepository.injectE2ESession).toHaveBeenCalledWith(expect.objectContaining({ jid: 'user3@s.whatsapp.net' }));
    }));
});
