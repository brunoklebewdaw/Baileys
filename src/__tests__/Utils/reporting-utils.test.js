...
describe('Reporting Utils', () => {
    ...
    describe('getMessageReportingToken', () => {
        const createKey = (overrides) => (Object.assign({ id: 'test-id', fromMe: true, remoteJid: '123@s.whatsapp.net' }, overrides));
        const withSecret = (content, secret = randomBytes(32)) => (Object.assign(Object.assign({}, content), { messageContextInfo: { messageSecret: secret } }));
        ...
        it('should return null when message secret is missing', () => __awaiter(void 0, void 0, void 0, function* () {
            const msg = { conversation: 'Hello' };
            expect(yield getMessageReportingToken(encode(msg), msg, createKey())).toBeNull();
        }));
        it('should return null when message key id is missing', () => __awaiter(void 0, void 0, void 0, function* () {
            const msg = withSecret({ conversation: 'Hello' });
            expect(yield getMessageReportingToken(encode(msg), msg, createKey({ id: '' }))).toBeNull();
        }));
        it('should return valid reporting node structure', () => __awaiter(void 0, void 0, void 0, function* () {
            const msg = withSecret({ conversation: 'Hello' });
        ...
        it('should produce consistent tokens for the same input', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it.each(uniquenessTests)('should produce different tokens for %s', (_, setup) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        ])('should handle %s', (_, keyOverrides) => __awaiter(void 0, void 0, void 0, function* () {
