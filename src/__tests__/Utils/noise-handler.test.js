...
describe('Noise Handler', () => {
	describe('decodeFrame with multiple frames in buffer', () => {
		it('should process multiple unencrypted frames in single buffer', () =>
		...
		it('should handle frames split across multiple decodeFrame calls', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
		...
		it('should correctly process frames when callback triggers async operations', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
	...
	describe('encrypted frame handling', () => {
		it('should encrypt and verify frame structure', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
		...
		it('should produce different ciphertext for same plaintext due to counter', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
	...
	describe('race condition scenario - concurrent decodeFrame calls', () => {
		it('should handle concurrent decodeFrame calls without corrupting inBytes buffer', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
		...
		it('should maintain counter integrity with many frames in single buffer', () =>
			__awaiter(void 0, void 0, void 0, function* () {
				const keyPair = Curve.generateKeyPair()
				const logger = createMockLogger()
				const handler = makeNoiseHandler({
	...
	describe('encrypted frame race condition', () => {
		...
		it('should serialize concurrent decodeFrame calls (fix for race condition)', () =>
			__awaiter(void 0, void 0, void 0, function* () {
		...
		it('should maintain frame order with interleaved partial frames after fix', () =>
			__awaiter(void 0, void 0, void 0, function* () {
