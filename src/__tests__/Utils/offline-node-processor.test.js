...
describe('makeOfflineNodeProcessor', () => {
    ...
    function createProcessor(handlers, batchSize = 10) {
        return makeOfflineNodeProcessor(handlers, {
            isWsOpen: () => isWsOpen,
            onUnexpectedError: mockOnUnexpectedError,
            yieldToEventLoop: () => __awaiter(this, void 0, void 0, function* () {
                yieldCalls++;
            })
        }, batchSize);
    }
    ...
    describe('basic processing', () => {
        it('should process a single enqueued node', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should process multiple nodes in FIFO order', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
                processed.push(node.attrs.id);
            }));
        ...
        it('should dispatch nodes to correct handler by type', () => __awaiter(void 0, void 0, void 0, function* () {
            const messageIds = [];
            const callIds = [];
            const receiptIds = [];
    ...
    describe('error resilience', () => {
        it('should continue processing after a handler throws', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should continue processing after multiple handler errors', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should report unknown node type and continue', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
                processed.push(node.attrs.id);
            }));
            ...
            yield new Promise(r => setTimeout(r, 10));
            expect(processed).toEqual(['msg-1']);
            expect(mockOnUnexpectedError).toHaveBeenCalledWith(expect.objectContaining({ message: expect.stringContaining('unknown offline node type') }), 'processing offline node');
        }));
    });
    describe('connection awareness', () => {
        it('should stop processing when connection closes', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
                processed.push(node.attrs.id);
                if (node.attrs.id === 'msg-2') {
        ...
        it('should resume processing when new nodes are enqueued after connection reopens', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
                processed.push(node.attrs.id);
            }));
    ...
    describe('batch yielding', () => {
        it('should yield to event loop after batchSize nodes', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should NOT yield for fewer nodes than batchSize', () => __awaiter(void 0, void 0, void 0, function* () {
            const handler = jest.fn().mockResolvedValue(undefined);
        ...
        it('should yield exactly at batchSize boundary', () => __awaiter(void 0, void 0, void 0, function* () {
            const handler = jest.fn().mockResolvedValue(undefined);
    ...
    describe('isProcessing guard', () => {
        it('should not start a second processing loop for concurrent enqueues', () => __awaiter(void 0, void 0, void 0, function* () {
            let resolveFirst;
    ...
    describe('mixed error types', () => {
        it('should handle both handler errors and unknown types in sequence', () => __awaiter(void 0, void 0, void 0, function* () {
            const processed = [];
            const handler = jest.fn().mockImplementation((node) => __awaiter(void 0, void 0, void 0, function* () {
                if (node.attrs.id === 'msg-2') {
