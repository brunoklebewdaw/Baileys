...
describe('Connection Deadlock Test', () => {
    it('should not deadlock when history sync is disabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const { state, clear } = yield makeSession();
        state.creds.me = { id: '1234567890:1@s.whatsapp.net', name: 'Test User' };
        const sock = makeWASocket(Object.assign(Object.assign({}, DEFAULT_CONNECTION_CONFIG), { auth: state, shouldSyncHistoryMessage: () => false }));
