...
describe('Identity Change Handling', () => {
    ...
    describe('Core Checks', () => {
        it('should skip companion devices (device > 0)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should process primary device (device 0 or undefined)', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should skip self-primary identity (PN match)', () => __awaiter(void 0, void 0, void 0, function* () {
            const node = createIdentityChangeNode('myuser@s.whatsapp.net');
            const result = yield handleIdentityChange(node, createContext());
            expect(mockValidateSession).not.toHaveBeenCalled();
            expect(result.action).toBe('skipped_self_primary');
        }));
        it('should skip self-primary identity (LID match)', () => __awaiter(void 0, void 0, void 0, function* () {
            const node = createIdentityChangeNode('mylid@lid');
            const result = yield handleIdentityChange(node, createContext());
            expect(mockValidateSession).not.toHaveBeenCalled();
            expect(result.action).toBe('skipped_self_primary');
        }));
        it('should skip when no existing session', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('should skip session refresh during offline processing', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
        ...
        it('should refresh session when online with existing session', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
            mockAssertSessions.mockResolvedValue(true);
            const node = createIdentityChangeNode('user@s.whatsapp.net');
            const result = yield handleIdentityChange(node, createContext());
    ...
    describe('Debounce', () => {
        it('should debounce multiple identity changes for the same JID', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
            mockAssertSessions.mockResolvedValue(true);
            const node = createIdentityChangeNode('user@s.whatsapp.net');
        ...
        it('should allow different JIDs to process independently', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
            mockAssertSessions.mockResolvedValue(true);
    ...
    describe('Error Handling', () => {
        it('should handle assertSessions failure gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
        ...
        it('should propagate validateSession errors', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('Edge Cases', () => {
        it('should return invalid_notification when from is missing', () => __awaiter(void 0, void 0, void 0, function* () {
            const node = {
                tag: 'notification',
                attrs: { type: 'encrypt' },
        ...
        it('should return no_identity_node when identity child is missing', () => __awaiter(void 0, void 0, void 0, function* () {
            const node = {
                tag: 'notification',
        ...
        it('should handle LID JIDs correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
            mockAssertSessions.mockResolvedValue(true);
    ...
    describe('onBeforeSessionRefresh callback', () => {
        it('fires before assertSessions when a session refresh is about to run', () => __awaiter(void 0, void 0, void 0, function* () {
            mockValidateSession.mockResolvedValue({ exists: true });
            const callOrder = [];
            mockAssertSessions.mockImplementation(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('does not fire when the refresh is skipped (no session / offline / self)', () => __awaiter(void 0, void 0, void 0, function* () {
            const onBeforeSessionRefresh = jest.fn();
            // no session
            mockValidateSession.mockResolvedValue({ exists: false });
            yield handleIdentityChange(createIdentityChangeNode('a@s.whatsapp.net'), Object.assign(Object.assign({}, createContext()), { onBeforeSessionRefresh }));
            // offline
            mockValidateSession.mockResolvedValue({ exists: true });
            yield handleIdentityChange(createIdentityChangeNode('b@s.whatsapp.net', '0'), Object.assign(Object.assign({}, createContext()), { onBeforeSessionRefresh }));
            // self-primary
            yield handleIdentityChange(createIdentityChangeNode(mockMeId), Object.assign(Object.assign({}, createContext()), { onBeforeSessionRefresh }));
