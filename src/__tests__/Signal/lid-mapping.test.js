...
describe('LIDMappingStore', () => {
	...
	describe('getPNForLID', () => {
		it('should correctly map a standard LID with a hosted device ID back to a standard PN with a hosted device', () =>
			__awaiter(void 0, void 0, void 0, function* () {
		...
		it('should return null if no reverse mapping is found', () =>
			__awaiter(void 0, void 0, void 0, function* () {
