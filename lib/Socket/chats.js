...
import { proto } from '../../WAProto/index.js'.js;
import { DEFAULT_CACHE_TTLS, HISTORY_SYNC_PAUSED_TIMEOUT_MS, PROCESSABLE_HISTORY_TYPES } from '../Defaults'.js;
import { ALL_WA_PATCH_NAMES } from '../Types'.js;
import { SyncState } from '../Types/State'.js;
import { chatModificationToAppPatch, decodePatches, decodeSyncdSnapshot, encodeSyncdPatch, ensureLTHashStateVersion, extractSyncdPatches, generateProfilePicture, getHistoryMsg, isAppStateSyncIrrecoverable, isMissingKeyError, MAX_SYNC_ATTEMPTS, newLTHashState, processSyncAction } from '../Utils'.js;
import { makeMutex } from '../Utils/make-mutex'.js;
import processMessage from '../Utils/process-message'.js;
import { buildTcTokenFromJid } from '../Utils/tc-token-utils'.js;
import { getBinaryNodeChild, getBinaryNodeChildren, isLidUser, isPnUser, jidDecode, jidNormalizedUser, isPnUser, isLidUser, isHostedLidUser, isHostedPnUser, reduceBinaryNodeToDictionary, S_WHATSAPP_NET } from '../WABinary'.js;
import { USyncQuery, USyncUser } from '../WAUSync'.js;
import { makeSocket } from './socket.js'.js;
