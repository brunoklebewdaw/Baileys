...
export declare const generateLegacyButtonsPayload: (content: {
    text: string;
    footer?: string;
    buttons: Array<{
        buttonId: string;
...
export declare const generateButtonPayload: (content: {
    text: string;
    buttons: Array<{
...
export declare const makeMessagesSocket: (config: SocketConfig) => {
    ...
    }, options?: MiscMessageGenerationOptions) => Promise<string>;
