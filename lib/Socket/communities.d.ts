...
export declare const makeCommunitiesSocket: (config: SocketConfig) => {
    ...
    sendMessage: (jid: string, content: import("../Types").AnyMessageContent, options?: import("../Types").MiscMessageGenerationOptions) => Promise<import("../Types").WAMessage>;
    ...
    }, options?: import("../Types").MiscMessageGenerationOptions) => Promise<string>;
