...
import { KEY_BUNDLE_TYPE, WA_ADV_ACCOUNT_SIG_PREFIX, WA_ADV_DEVICE_SIG_PREFIX, WA_ADV_HOSTED_ACCOUNT_SIG_PREFIX } from '../Defaults'.js;
import { getBinaryNodeChild, jidDecode, S_WHATSAPP_NET } from '../WABinary'.js;
import { Curve, hmacSign } from './crypto.js'.js;
import { encodeBigEndian } from './generics.js'.js;
import { createSignalIdentity } from './signal.js'.js;
