...
function longToStringOld(value, unsigned) {
    ...
    const prepared = unsigned && normalized && typeof normalized.toUnsigned === 'function' ? normalized.toUnsigned() : normalized;
    return prepared.toString();
}
// bigint implementation
function longToStringNew(value, unsigned) {
    if (typeof value === 'string')
        return value;
    if (typeof value === 'number')
        return String(value);
...
function longToNumberOld(value, unsigned) {
    if (typeof value === 'number')
        return value;
    if (typeof value === 'string')
        return Number(value);
...
function longToNumberNew(value, unsigned) {
    if (typeof value === 'number')
        return value;
    if (typeof value === 'string')
        return Number(value);
...
//# sourceMappingURL=bigint-validation.test.js.map