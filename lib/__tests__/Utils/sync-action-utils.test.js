...
describe('processContactAction', () => {
    ...
    describe('missing id', () => {
        it('returns empty array and logs warning when id is undefined', () => {
            ...
            expect(mockLogger.warn).toHaveBeenCalledWith({ hasFullName: true, hasLidJid: true, hasPnJid: false }, 'contactAction sync: missing id in index');
        });
...
//# sourceMappingURL=sync-action-utils.test.js.map